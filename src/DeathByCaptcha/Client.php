...
abstract class Client
{
     ...
     * @throws Exception\InvalidCaptchaException On invalid CAPTCHA images
     */
     ...
     *
     * @uses DeathByCaptcha\Client::get_user()
     * @return float|null
     */
     ...
     *
     * @uses DeathByCaptcha\Client::get_captcha()
     * @param int $cid CAPTCHA ID
     * @return string|null
     */
     ...
     * @throws Exception\InvalidCaptchaException On invalid CAPTCHA file
     */
    abstract public function upload($captcha);

    /**
     * Tries to solve CAPTCHA by uploading it and polling for its status/text
     * with arbitrary timeout. See {@link DeathByCaptcha\Client::upload()} for
     * $captcha param details.
     *
     * @uses DeathByCaptcha\Client::upload()
     * @uses DeathByCaptcha\Client::get_captcha()
     ...
     * @throws Exception\RuntimeException On missing/empty DBC account credentials
     * @throws Exception\RuntimeException When required extensions/functions not found
     */
