...
class SocketClient extends Client
{
     ...
     *
     * @throws Exception\IOException When API connection fails
     * @throws Exception\RuntimeException When socket operations fail
     */
     ...
     * @throws Exception\IOException On network failures
     */
    protected function _sendrecv($buf)
    {
        ...
        throw new Exception\IOException('API request timed out');
    }
     ...
     * @throws Exception\IOException On network errors
     * @throws Exception\AccessDeniedException On failed login attempt
     * @throws Exception\InvalidCaptchaException On invalid CAPTCHAs rejected by the service
     * @throws Exception\ServerException On API server errors
     */
            ...
            if (!empty($response['error'])) {
                switch ($response['error']) {
                    ...
                    case 'service-overload':
                        throw new Exception\ServiceOverloadException(
